...
public class MsgUtil {
    ...
    public static final Integer REQUEST_EXCESSIVE=-90;
    ...
    public static final String VISITING_TOO_OFTEN_MSG="Visit too often";
    public static final String REQUEST_EXCESSIVE_MSG="Access out of limit";
