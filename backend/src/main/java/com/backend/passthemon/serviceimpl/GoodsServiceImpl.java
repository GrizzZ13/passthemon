...
//        }
    ...
    @Override
    public Goods addGood(Goods goods){return goodsRepository.addGood(goods); }

    @Override
    public  Integer editGood(GoodInfoDto goodInfoDto,Integer userId){
         return goodsRepository.editGood(goodInfoDto,userId);
    }
    @Override
    public Integer removeGoods(Integer goodsId,Integer userId){
        return this.goodsRepository.removeGoods(goodsId,userId);
    }
    @Override
